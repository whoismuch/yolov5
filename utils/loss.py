...
class ComputeLoss:
    ...
    # Compute losses
    def __init__(self, model, autobalance=False, rademacher_lambda=0.1, group_lasso_weight=1.0):
    ...
    def __call__(self, p, targets):  # predictions, targets
        ...
        loss = (lbox + lobj + lcls + rademacher_penalty + group_lasso_loss) * bs

        return loss, torch.cat((lbox, lobj, lcls, rademacher_penalty_tensor, group_lasso_loss_tensor)).detach()
