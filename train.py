...
def train(hyp, opt, device, callbacks):
    ...
    compute_loss = ComputeLoss(model, rademacher_lambda=0.000005, group_lasso_weight=0.2)  # init loss class
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        LOGGER.info(("\n" + "%17s" * 9) % ("Epoch", "GPU_mem", "box_loss", "obj_loss", "cls_loss", "rademacher_loss", "group_lasso", "Instances", "Size"))
        if RANK in {-1, 0}:
