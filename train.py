...
def train(hyp, opt, device, callbacks):
    ...
    compute_loss = ComputeLoss(model, rademacher_lambda=0.0000005)  # init loss class
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        LOGGER.info(("\n" + "%17s" * 8) % ("Epoch", "GPU_mem", "box_loss", "obj_loss", "cls_loss", "rademacher_loss", "Instances", "Size"))
        if RANK in {-1, 0}:
